...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_return.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  %1 = alloca %"class.llvm::Module"*, align 8
  %2 = alloca %"class.llvm::StringRef", align 8
  %3 = call i8* @_Znwm(i64 704) #8
  %4 = bitcast i8* %3 to %"class.llvm::Module"*
  call void @_ZN4llvm9StringRefC2EPKc(%"class.llvm::StringRef"* %2, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0))
  %5 = bitcast %"class.llvm::StringRef"* %2 to { i8*, i64 }*
  %6 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %5, i32 0, i32 0
  %7 = load i8*, i8** %6, align 8
  %8 = getelementptr inbounds { i8*, i64 }, { i8*, i64 }* %5, i32 0, i32 1
  %9 = load i64, i64* %8, align 8
  call void @_ZN4llvm6ModuleC1ENS_9StringRefERNS_11LLVMContextE(%"class.llvm::Module"* %4, i8* %7, i64 %9, %"class.llvm::LLVMContext"* dereferenceable(8) @context)
  store %"class.llvm::Module"* %4, %"class.llvm::Module"** %1, align 8
  %10 = load %"class.llvm::Module"*, %"class.llvm::Module"** %1, align 8
  %11 = call dereferenceable(40) %"class.llvm::raw_ostream"* @_ZN4llvm4errsEv()
  call void @_ZNK4llvm6Module5printERNS_11raw_ostreamEPNS_24AssemblyAnnotationWriterEbb(%"class.llvm::Module"* %10, %"class.llvm::raw_ostream"* dereferenceable(40) %11, %"class.llvm::AssemblyAnnotationWriter"* null, i1 zeroext false, i1 zeroext false)
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define internal void @_GLOBAL__sub_I_return.cpp() #0 section ".text.startup" {
